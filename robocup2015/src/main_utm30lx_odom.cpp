...
{
	ROS_INFO("pause_mapping service triggered/n");
...
int main(int argc, char ** argv)
{
	...
	ros::ServiceServer service = n.advertiseService("pause_mapping" , pause);
	...
	int p1 = 0,p2 = 0;
	//ofstream ofile;
	//ofile.open("/home/robocup/desktop/log2.txt");
